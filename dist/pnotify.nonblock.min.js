...
this.fireEvent(b,c))},e,d=function(b,a,c){b.elem.addClass("ui-pnotify-nonblock-hide");var g=document.elementFromPoint(a.clientX,a.clientY);b.elem.removeClass("ui-pnotify-nonblock-hide");var d=f(g),k=d.css("cursor");"auto"===k&&"A"===g.tagName&&(k="pointer");b.elem.css("cursor","auto"!==k?k:"default");e&&e.get(0)==g||(e&&(h.call(e.get(0),"mouseleave",a.originalEvent),h.call(e.get(0),"mouseout",a.originalEvent)),h.call(g,"mouseenter",a.originalEvent),h.call(g,"mouseover",a.originalEvent));h.call(g,
c,a.originalEvent);e=d};l.prototype.options.nonblock={nonblock:!1};l.prototype.modules.nonblock={myOptions:null,init:function(b,a){var c=this;this.myOptions=a;b.elem.on({mouseenter:function(a){c.myOptions.nonblock&&a.stopPropagation();c.myOptions.nonblock&&b.elem.addClass("ui-pnotify-nonblock-fade")},mouseleave:function(a){c.myOptions.nonblock&&a.stopPropagation();e=null;b.elem.css("cursor","auto");c.myOptions.nonblock&&"out"!==b.animating&&b.elem.removeClass("ui-pnotify-nonblock-fade")},mouseover:function(a){c.myOptions.nonblock&&
