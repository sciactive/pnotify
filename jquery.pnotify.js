	...
	var history_handle_top,
		...
		styling = {
			...
			bootstrap: {
				...
				notice_icon: "icon-exclamation-sign glyphicon glyphicon-exclamation-sign",
				info: "alert-info",
				info_icon: "icon-info-sign glyphicon glyphicon-info-sign",
				success: "alert-success",
				success_icon: "icon-ok-sign glyphicon glyphicon-ok-sign",
				error: "alert-error alert-danger",
				error_icon: "icon-warning-sign glyphicon glyphicon-warning-sign",
				closer: "icon-remove glyphicon glyphicon-remove",
				pin_up: "icon-pause glyphicon glyphicon-pushpin",
				pin_down: "icon-play glyphicon glyphicon-play",
				hi_menu: "well",
				hi_btn: "btn",
				hi_btnhov: "",
